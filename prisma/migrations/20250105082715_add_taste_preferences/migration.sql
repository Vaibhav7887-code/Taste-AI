/*
  ...
  - Added the required column `tastePreferences` to the `TasteProfile` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_TasteProfile" (
    ...
    "tastePreferences" TEXT NOT NULL,
